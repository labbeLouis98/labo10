...
function theme4w4_scripts() {
    ...
    wp_register_script( 'theme4w4-carrousel', get_template_directory_uri() . '/js/carrousel.js', array(), _S_VERSION, true );

	wp_register_script( 'theme4w4-carrousel-2', get_template_directory_uri() . '/js/carrousel-2.js', array(), _S_VERSION , true );
	wp_register_script( 'theme4w4-rest-api', get_template_directory_uri() . '/js/rest_api.js', array(), _S_VERSION , true );
    
    if( is_front_page()){
        wp_enqueue_script( 'theme4w4-carrousel');
		wp_enqueue_script( 'theme4w4-carrousel-2');
